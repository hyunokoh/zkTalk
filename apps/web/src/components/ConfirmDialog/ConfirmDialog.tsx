  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/70 px-4" onClick={onCancel}>
      <div
        ...
        className="w-full max-w-md rounded-2xl border border-white/10 bg-[#111827] p-6 shadow-[0_30px_70px_rgba(0,0,0,0.45)]"
      ...
      >
        ...
        <div className="mt-6 flex justify-end gap-3">
          <button
            ...
            onClick={onCancel}
            disabled={isPending}
            className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-gray-200 transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {cancelLabel}
          </button>
          <button
