        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          ...
          <div className="flex flex-col gap-3 xl:min-w-[420px] xl:max-w-[560px] xl:flex-1 xl:items-end">
            ...
            >
              ...
              <button
                type="submit"
                className="rounded-xl bg-accent px-4 py-3 text-sm font-semibold text-[color:var(--on-accent)] transition-colors hover:bg-accent-strong"
              >
            ...
            <div className="flex w-full items-center justify-between gap-3 xl:max-w-[560px]">
              ...
              <Link
                ...
                className="rounded-xl bg-accent px-4 py-2 text-sm font-medium text-[color:var(--on-accent)] transition-colors hover:bg-accent-strong"
              >
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              action={(
                <Link
                  href="/communities/new"
                  className="inline-block rounded-xl bg-accent px-4 py-2 text-sm font-medium text-[color:var(--on-accent)] transition-colors hover:bg-accent-strong"
                >
                  {t('community.createCommunity')}
                </Link>
              )}
