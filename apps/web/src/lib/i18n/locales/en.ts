const en = {
  ...
  'cards.extractTitle': 'Auto-extract from card scan',
  'cards.extractHint': 'Reads the card image with AI and fills in any empty fields. Your typed values are kept.',
  'cards.extractButton': 'Auto-extract',
  'cards.extractRunning': 'Reading…',
