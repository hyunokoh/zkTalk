ALTER TABLE "channels" ADD COLUMN IF NOT EXISTS "disappearing_duration" integer;--> statement-breakpoint
ALTER TABLE "channels" ADD COLUMN IF NOT EXISTS "require_topic" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "messages" ADD COLUMN IF NOT EXISTS "topic" text;--> statement-breakpoint
ALTER TABLE "messages" ADD COLUMN IF NOT EXISTS "expires_at" timestamp with time zone;--> statement-breakpoint
...
ALTER TABLE "attachments" ADD COLUMN IF NOT EXISTS "upload_session_id" text;--> statement-breakpoint
ALTER TABLE "attachments" ADD COLUMN IF NOT EXISTS "bucket" text DEFAULT 'zktalk-uploads' NOT NULL;--> statement-breakpoint
ALTER TABLE "attachments" ADD COLUMN IF NOT EXISTS "object_key" text DEFAULT '' NOT NULL;--> statement-breakpoint
