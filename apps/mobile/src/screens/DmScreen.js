    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            __assign(__assign({}, message), { bodyPlaintext: t('dm.decryptFailed') }),
          ];
        case 4:
          return [2 /*return*/];
      }
...
function DmScreen(_a) {
  ...
  var _l = route.params,
    conversationId = _l.conversationId,
    _m = _l.userId,
    userId = _m === void 0 ? '' : _m,
    _o = _l.displayName,
    displayName = _o === void 0 ? '' : _o;
  var _p = (0, i18n_1.useTranslation)(),
    t = _p.t,
    locale = _p.locale;
  var _q = (0, react_1.useState)([]),
    pendingMessages = _q[0],
    setPendingMessages = _q[1];
  var _r = (0, react_1.useState)(null),
    pendingAttachment = _r[0],
    setPendingAttachment = _r[1];
  var _s = (0, react_1.useState)(false),
    showAttachMenu = _s[0],
    setShowAttachMenu = _s[1];
  ...
  var _v = (0, react_1.useState)(null),
    editingMessage = _v[0],
    setEditingMessage = _v[1];
  var _w = (0, react_1.useState)(null),
    actionMessage = _w[0],
    setActionMessage = _w[1];
  var _x = (0, react_1.useState)({}),
    translatedBodies = _x[0],
    setTranslatedBodies = _x[1];
  var _y = (0, react_1.useState)(null),
    selectedMessageId = _y[0],
    setSelectedMessageId = _y[1];
  var _z = (0, react_1.useState)(''),
    composerDraftText = _z[0],
    setComposerDraftText = _z[1];
  var _0 = (0, react_1.useState)(''),
    composerDraftSeed = _0[0],
    setComposerDraftSeed = _0[1];
  var _1 = (0, react_1.useState)(null),
    composerDraftKey = _1[0],
    setComposerDraftKey = _1[1];
  var _2 = (0, react_1.useState)(false),
    showPromoteModal = _2[0],
    setShowPromoteModal = _2[1];
  var _3 = (0, react_1.useState)(null),
    errorDialog = _3[0],
    setErrorDialog = _3[1];
  var _4 = (0, react_1.useState)(null),
    promotedConflictTarget = _4[0],
    setPromotedConflictTarget = _4[1];
  var _5 = (0, react_1.useState)(displayName || t('dm.groupConversation')),
    promotionCommunityName = _5[0],
    setPromotionCommunityName = _5[1];
  var _6 = (0, react_1.useState)('general'),
    promotionChannelName = _6[0],
    setPromotionChannelName = _6[1];
  ...
  var _8 = (0, react_1.useState)(null),
    openingAttachmentId = _8[0],
    setOpeningAttachmentId = _8[1];
  var _9 = (0, react_1.useState)(null),
    previewGallery = _9[0],
    setPreviewGallery = _9[1];
  ...
  var _10 = (0, useWebSocket_1.useDmSubscription)(conversationId),
    queuedEventCount = _10.queuedEventCount,
    consumeEvents = _10.consumeEvents;
  var scheduleDmRefresh = (0, react_1.useCallback)(
    function (delayMs) {
      if (delayMs === void 0) {
        delayMs = 1200;
      }
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              ...
              case 4:
                ...
                return [
                  4 /*yield*/,
                  (0, crypto_1.deriveSharedKey)(keyPair.privateKey, otherUser.publicKey),
                ];
              case 5:
                derived = _b.sent();
  ...
  var _7 = (0, react_query_1.useQuery)({
                ...
                return [
                  ...
                  Promise.all(
                    messages.map(function (message) {
                      return hydrateDmMessage(message, sharedKey, t);
                    }),
                  ),
                ];
              case 2:
    ...
    data = _7.data,
    isLoading = _7.isLoading,
    refetch = _7.refetch,
    isRefetching = _7.isRefetching;
  var loadConversationDetail = (0, react_1.useCallback)(
    function () {
      return (0, api_1.api)('/api/dm/conversations/'.concat(conversationId));
    },
    [conversationId],
  );
  ...
  var promotedTarget =
    (conversationDetail === null || conversationDetail === void 0
      ? void 0
      : conversationDetail.promotedCommunity) &&
    (conversationDetail === null || conversationDetail === void 0
      ? void 0
      : conversationDetail.promotedChannel)
      ? {
      ...
      : null;
  var unreadCounts =
    (_b = data === null || data === void 0 ? void 0 : data.unreadCounts) !== null && _b !== void 0
      ? _b
      : {};
  var latestVisibleMessageId =
    (_d =
      (_c = data === null || data === void 0 ? void 0 : data.messages[0]) === null || _c === void 0
        ? void 0
              ...
              return __generator(this, function (_b) {
                switch (_b.label) {
                  case 0:
                    ...
                    return [
                      4 /*yield*/,
                      (0, api_1.api)('/api/dm/conversations/'.concat(conversationId, '/read'), {
                        method: 'POST',
  ...
  var navigateToPromotedCommunity = (0, react_1.useCallback)(
    function (target) {
      if (!target) {
        return;
      }
  ...
  var handlePromotedReadOnlyError = (0, react_1.useCallback)(
    function (error) {
      return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_c) {
                    switch (_c.label) {
                      ...
                      case 1:
                        return [
                          4 /*yield*/,
                          hydrateDmMessage(flattenDmMessage(event_1.payload), sharedKey, t),
                        ];
                      case 2:
                        payload_1 = _c.sent();
                        queryClient.setQueryData(dmMessagesQueryKey, function (old) {
                          ...
                          return {
                            ...
                            unreadCounts:
                              (_a = old.unreadCounts) !== null && _a !== void 0 ? _a : {},
                          };
                        });
                        queryClient.invalidateQueries({ queryKey: ['dm-conversations'] });
                        scheduleDmRefresh();
                        ...
                        queryClient.setQueryData(dmMessagesQueryKey, function (old) {
                          ...
                          return {
                            messages: old.messages.map(function (message) {
                              return message.id === payload_2.id
                                ? __assign(__assign({}, message), payload_2)
                                : message;
                            }),
                            unreadCounts:
                              (_a = old.unreadCounts) !== null && _a !== void 0 ? _a : {},
                      ...
                      case 5:
                        {
                          ...
                          if (!deletedId_1) return [3 /*break*/, 7];
                          queryClient.setQueryData(dmMessagesQueryKey, function (old) {
                            var _a;
                            if (!old) return old;
                            return {
                              messages: old.messages.filter(function (message) {
                                return message.id !== deletedId_1;
                              }),
                              unreadCounts:
                                (_a = old.unreadCounts) !== null && _a !== void 0 ? _a : {},
                            };
        ...
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                queued = _a.sent();
                dmPending = queued.filter(function (m) {
                  return m.endpoint === endpoint;
                });
                setPendingMessages(
                  dmPending.map(function (m) {
                    var _a;
                    return {
                      id: m.id,
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            ...
            case 2:
              return [
                4 /*yield*/,
                (0, api_1.api)('/api/dm/messages/'.concat(editingMessage.id), {
                  method: 'PATCH',
                  body: messageBody,
                }),
              ];
              ...
              pendingAttachmentName =
                (_b =
                  pendingAttachment === null || pendingAttachment === void 0
                    ? void 0
                    : pendingAttachment.name) !== null && _b !== void 0
                  ? _b
                  : null;
              if (!pendingAttachment) return [3 /*break*/, 6];
              return [
                4 /*yield*/,
                (0, file_picker_1.uploadFile)(pendingAttachment, {
            ...
            case 11:
              ...
              if (
                !(
                  attachmentData &&
                  ((_c = result.message) === null || _c === void 0 ? void 0 : _c.id)
                )
              )
                return [3 /*break*/, 13];
              return [
                4 /*yield*/,
                (0, file_picker_1.attachToDmMessage)(result.message.id, attachmentData),
              ];
            case 12:
              _d.sent();
              _d.label = 13;
            ...
            case 14:
              ...
              return [
                4 /*yield*/,
                (0, offline_queue_1.enqueueMessage)(endpoint, { bodyMarkdown: fallbackBody_1 }),
              ];
            case 15:
              queued_1 = _d.sent();
  ...
  var promoteMutation = (0, react_query_1.useMutation)({
    mutationFn: function (_a) {
      var communityName = _a.communityName,
    ...
    function (text) {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (sendMutation.isPending) return [2 /*return*/, false];
              _a.label = 1;
            case 1:
              _a.trys.push([1, 3, , 6]);
            ...
            case 3:
              ...
              if (
                !(
                  !isOffline &&
                  error_1 instanceof api_1.ApiError &&
                  error_1.code === 'DM_PROMOTED_READ_ONLY'
                )
              )
                return [3 /*break*/, 5];
          ...
          switch (_a.label) {
            ...
            case 2:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                error_2 instanceof Error ? error_2.message : t('common.errorOccurred'),
              );
              return [3 /*break*/, 3];
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                error_3 instanceof Error ? error_3.message : t('common.errorOccurred'),
              );
              return [3 /*break*/, 3];
            case 3:
              return [2 /*return*/];
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 7:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                error_5 instanceof Error ? error_5.message : t('channel.openAttachmentFailed'),
              );
              return [3 /*break*/, 9];
            case 8:
  ...
  var renderAttachments = (0, react_1.useCallback)(
    function (attachments) {
      ...
      return (
        <react_native_1.View style={styles.attachments}>
          {imageAttachments.length > 0 ? (
            <react_native_1.View style={styles.attachmentImageGrid}>
              {imageAttachments.slice(0, 4).map(function (attachment) {
                return (
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 2:
                _a.trys.push([2, , 8, 9]);
                if (
                  (payload === null || payload === void 0 ? void 0 : payload.conversationId) !==
                  conversationId
                ) {
                  return [2 /*return*/];
                }
    ...
    function () {
      ...
      return (0, api_1.api)('/api/translate', {
        ...
        .catch(function (error_6) {
          react_native_1.Alert.alert(
            t('common.error'),
            error_6 instanceof Error ? error_6.message : t('message.translateFailed'),
          );
        });
    },
          ...
          switch (_a.label) {
            case 0:
              ...
              contract = (0, ai_1.buildSelectedMessageAiAction)({
                ...
                sourceMessage: {
                  authorDisplayName:
                    ((_b = actionMessage.author) === null || _b === void 0
                      ? void 0
            ...
            case 3:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                (0, error_message_1.getUserFacingErrorMessage)(error_7, t),
              );
              return [3 /*break*/, 4];
            case 4:
              return [2 /*return*/];
  ...
  var handleAiRewriteDraft = (0, react_1.useCallback)(
    function () {
      return __awaiter(_this, void 0, void 0, function () {
        var contract, rewrittenDraft, error_8;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (!actionMessage) {
            ...
            case 3:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                (0, error_message_1.getUserFacingErrorMessage)(error_8, t),
              );
              return [3 /*break*/, 4];
            case 4:
              return [2 /*return*/];
  ...
  var handlePromoteToCommunity = (0, react_1.useCallback)(
    function () {
      if (promotedTarget) {
  ...
  var submitPromoteToCommunity = (0, react_1.useCallback)(
    function () {
  ...
  var handleStartCall = (0, react_1.useCallback)(
        ...
        headerRight: function () {
          return (
            <react_native_1.View style={styles.headerActions}>
              ...
              >
                <react_native_1.Text style={styles.headerIconText}>{'\u2706'}</react_native_1.Text>
              </react_native_1.TouchableOpacity>
              <react_native_1.TouchableOpacity
  ...
  var messages = react_1.default.useMemo(
    function () {
      var _a;
      var seen = new Set();
      return (
        (_a = data === null || data === void 0 ? void 0 : data.messages) !== null && _a !== void 0
          ? _a
          : []
  ...
  return (
    ...
    >
                    ...
                    isOwn
                      ? (_c =
                          currentUser === null || currentUser === void 0
                            ? void 0
                            : currentUser.displayName) !== null && _c !== void 0
                        ? _c
                        : t('common.you')
                      : (_f =
                            (_e =
                              (_d = item.author) === null || _d === void 0
                                ? void 0
                                : _d.displayName) !== null && _e !== void 0
                              ? _e
                              : displayName) !== null && _f !== void 0
                        ? _f
                        : t('common.unknown')
                  }
                  authorAvatarUrl={
                    (_h = (_g = item.author) === null || _g === void 0 ? void 0 : _g.avatarUrl) !==
                      null && _h !== void 0
                      ? _h
                      : null
                  }
      ...
      {pendingAttachment && !promotedTarget ? (
        <react_native_1.View testID="dm-pending-attachment" style={styles.pendingAttachmentPreview}>
          {(0, shared_1.isImageAttachmentMimeType)(
            pendingAttachment.mimeType,
            pendingAttachment.name,
          ) ? (
            ...
            <react_native_1.View style={styles.pendingAttachmentFallback}>
          ...
          <react_native_1.View style={styles.pendingAttachmentInfo}>
            <react_native_1.Text
              testID="dm-pending-attachment-name"
          ...
          >
            <react_native_1.Text style={styles.pendingAttachmentRemoveText}>
              {'\u2715'}
            </react_native_1.Text>
          </react_native_1.TouchableOpacity>
        </react_native_1.View>
      ...
      {showAttachMenu && !promotedTarget ? (
        <react_native_1.View testID="dm-attach-menu" style={styles.attachMenu}>
          <react_native_1.TouchableOpacity
      ...
      {promotedTarget ? (
        <react_native_1.View style={styles.promotedComposer}>
          <react_native_1.View style={styles.promotedComposerContent}>
            <react_native_1.View style={styles.historyBadge}>
              <react_native_1.Text style={styles.historyBadgeText}>
                {t('dm.historyBadge')}
              </react_native_1.Text>
            </react_native_1.View>
            <react_native_1.Text style={styles.promotedComposerTitle}>
          ...
          <react_native_1.TouchableOpacity
            onPress={handlePromoteToCommunity}
            style={styles.promotedComposerButton}
          >
            <react_native_1.Text style={styles.promotedComposerButtonText}>
              {t('dm.goToCurrentChannelShort')}
            </react_native_1.Text>
          </react_native_1.TouchableOpacity>
        </react_native_1.View>
      ) : (
          ...
          draftText={
            (_f =
              editingMessage === null || editingMessage === void 0
                ? void 0
                : editingMessage.bodyPlaintext) !== null && _f !== void 0
              ? _f
              : composerDraftSeed
          }
          draftKey={
      ...
      {previewGallery ? (
        <AttachmentLightbox_1.default
          ...
          isSharing={
            openingAttachmentId ===
            ((_h = previewGallery.attachments[previewGallery.index]) === null || _h === void 0
              ? void 0
              : _h.id)
          }
      ...
      >
        <react_native_1.View style={styles.promoteBackdrop}>
          <react_native_1.View style={styles.promoteSheet}>
            ...
            <react_native_1.Text style={styles.promoteLabel}>
            ...
            <react_native_1.TextInput
              ...
              placeholderTextColor={theme_1.colors.textSecondary}
            ...
            <react_native_1.View style={styles.promoteActions}>
              ...
              >
                <react_native_1.Text style={styles.promoteSecondaryButtonText}>
                  {t('common.cancel')}
                </react_native_1.Text>
              </react_native_1.TouchableOpacity>
              <react_native_1.TouchableOpacity
              ...
              >
                {promoteMutation.isPending ? (
                  <react_native_1.ActivityIndicator size="small" color="#20262d" />
                ) : (
                  <react_native_1.Text style={styles.promotePrimaryButtonText}>
                    {t('dm.promoteSubmit')}
                  </react_native_1.Text>
                )}
              </react_native_1.TouchableOpacity>
      ...
      <react_native_1.Modal
        ...
        animationType="fade"
        onRequestClose={function () {
          return setPromotedConflictTarget(null);
        }}
      >
        <react_native_1.View style={styles.promoteBackdrop}>
          <react_native_1.View style={styles.promoteSheet}>
            <react_native_1.Text style={styles.promoteTitle}>
              {t('dm.promotedConflictTitle')}
            </react_native_1.Text>
            <react_native_1.Text style={styles.promoteDescription}>
      ...
      >
        <react_native_1.View style={styles.promoteBackdrop}>
          <react_native_1.View style={styles.promoteSheet}>
            <react_native_1.Text style={styles.promoteTitle}>
              {(_j =
                errorDialog === null || errorDialog === void 0 ? void 0 : errorDialog.title) !==
                null && _j !== void 0
                ? _j
                : t('common.error')}
            </react_native_1.Text>
            <react_native_1.Text style={styles.promoteDescription}>
              {(_k =
                errorDialog === null || errorDialog === void 0 ? void 0 : errorDialog.message) !==
                null && _k !== void 0
                ? _k
                : ''}
            </react_native_1.Text>
...
function formatFileSize(bytes) {
  if (bytes >= 1024 * 1024) return ''.concat((bytes / (1024 * 1024)).toFixed(1), ' MB');
  if (bytes >= 1024) return ''.concat(Math.round(bytes / 1024), ' KB');
