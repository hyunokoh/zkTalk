...
function flattenThreadMessage(row) {
  var _a, _b;
  if ('message' in row) {
    return __assign(__assign({}, row.message), {
      author: row.author,
      attachments:
        (_b = (_a = row.attachments) !== null && _a !== void 0 ? _a : row.message.attachments) !==
          null && _b !== void 0
          ? _b
          : [],
    });
...
function ThreadScreen(_a) {
  ...
  var navigation = _a.navigation,
    route = _a.route;
  var _12 = route.params,
    threadId = _12.threadId,
    channelId = _12.channelId,
    rootMessageId = _12.rootMessageId,
    focusMessageId = _12.focusMessageId;
  var _13 = (0, i18n_1.useTranslation)(),
    t = _13.t,
    locale = _13.locale;
  ...
  var currentUser = (0, auth_1.useAuthStore)(function (state) {
    return state.user;
  });
  var _14 = (0, useWebSocket_1.useChannelSubscription)(channelId),
    queuedEventCount = _14.queuedEventCount,
    consumeEvents = _14.consumeEvents;
  var wsStatus = (0, useWebSocket_1.useWebSocketStatus)();
  var shouldPollReplies = wsStatus !== 'connected';
  var _15 = react_1.default.useState(null),
    editingMessage = _15[0],
    setEditingMessage = _15[1];
  var _16 = react_1.default.useState(null),
    actionMessage = _16[0],
    setActionMessage = _16[1];
  var _17 = react_1.default.useState({}),
    translatedBodies = _17[0],
    setTranslatedBodies = _17[1];
  var _18 = react_1.default.useState(null),
    pendingAttachment = _18[0],
    setPendingAttachment = _18[1];
  var _19 = react_1.default.useState(null),
    uploadProgress = _19[0],
    setUploadProgress = _19[1];
  var _20 = react_1.default.useState(false),
    showAttachMenu = _20[0],
    setShowAttachMenu = _20[1];
  var _21 = react_1.default.useState(null),
    authToken = _21[0],
    setAuthToken = _21[1];
  var _22 = react_1.default.useState(null),
    openingAttachmentId = _22[0],
    setOpeningAttachmentId = _22[1];
  var _23 = react_1.default.useState(null),
    previewGallery = _23[0],
    setPreviewGallery = _23[1];
  var _24 = react_1.default.useState(null),
    selectedMessageId = _24[0],
    setSelectedMessageId = _24[1];
  var _25 = react_1.default.useState(''),
    composerDraftText = _25[0],
    setComposerDraftText = _25[1];
  var _26 = react_1.default.useState(''),
    composerDraftSeed = _26[0],
    setComposerDraftSeed = _26[1];
  var _27 = react_1.default.useState(null),
    composerDraftKey = _27[0],
    setComposerDraftKey = _27[1];
  var _28 = (0, react_1.useState)(''),
    searchQuery = _28[0],
    setSearchQuery = _28[1];
  var _29 = (0, react_1.useState)('all'),
    filterMode = _29[0],
    setFilterMode = _29[1];
  var _30 = (0, react_1.useState)(null),
    participantFilterUserId = _30[0],
    setParticipantFilterUserId = _30[1];
  var _31 = (0, react_1.useState)('time'),
    sortField = _31[0],
    setSortField = _31[1];
  var _32 = (0, react_1.useState)('oldest'),
    sortOrder = _32[0],
    setSortOrder = _32[1];
  var _33 = (0, react_1.useState)(null),
    jumpHighlightMessageId = _33[0],
    setJumpHighlightMessageId = _33[1];
  ...
  var threadQuery = (0, react_query_1.useQuery)({
    ...
    queryFn: function () {
      return (0, api_1.api)('/api/threads/'.concat(threadId));
    },
  });
  ...
  var repliesQuery = (0, react_query_1.useInfiniteQuery)({
          ...
          switch (_c.label) {
            case 0:
              return [
                ...
                (0, api_1.api)(
                  '/api/threads/'
                    .concat(threadId, '/messages')
                    .concat(pageParam ? '?cursor='.concat(encodeURIComponent(pageParam)) : ''),
                ),
              ];
            case 1:
              result = _c.sent();
    ...
    getNextPageParam: function (lastPage) {
      var _a;
      return (_a = lastPage.nextCursor) !== null && _a !== void 0 ? _a : undefined;
    },
    refetchInterval: shouldPollReplies ? 30000 : false,
  });
  var scheduleThreadRefresh = (0, react_1.useCallback)(
    function (delayMs) {
      if (delayMs === void 0) {
        delayMs = 1200;
      }
  ...
  var rootMessage = ((_b = threadQuery.data) === null || _b === void 0 ? void 0 : _b.rootMessage)
    ...
    : null;
  var starterUserId =
    (_c = rootMessage === null || rootMessage === void 0 ? void 0 : rootMessage.authorUserId) !==
      null && _c !== void 0
      ? _c
      : (_d = threadQuery.data) === null || _d === void 0
        ? void 0
        : _d.creator.id;
  var replies = (0, react_1.useMemo)(
    function () {
      var _a, _b;
      return __spreadArray(
        [],
        (_b = (_a = repliesQuery.data) === null || _a === void 0 ? void 0 : _a.pages) !== null &&
          _b !== void 0
          ? _b
          : [],
        true,
  ...
  var mergedReplies = (0, react_1.useMemo)(
    function () {
      ...
      if (
        ...
        replies.some(function (message) {
          return message.id === focusedMessage.id;
        })
      ) {
        return replies;
      }
      return __spreadArray(__spreadArray([], replies, true), [focusedMessage], false).sort(
        function (left, right) {
  ...
  var messageIds = __spreadArray(
    __spreadArray([], rootMessage ? [rootMessage.id] : [], true),
    mergedReplies.map(function (message) {
      return message.id;
    }),
    true,
  );
  ...
  var reactionsByMessageId =
    (_e =
      reactionsData === null || reactionsData === void 0
        ? void 0
        : reactionsData.reactionsByMessageId) !== null && _e !== void 0
      ? _e
      : {};
  var filterCounts = (0, react_1.useMemo)(
    function () {
      var _a, _b;
      var lastReadMessageId =
        (_b = (_a = threadQuery.data) === null || _a === void 0 ? void 0 : _a.lastReadMessageId) !==
          null && _b !== void 0
          ? _b
          : null;
      return {
        ...
        mine: mergedReplies.filter(function (message) {
          return (
        ...
        reactions: mergedReplies.filter(function (message) {
          var _a, _b;
          return (
            ((_b =
              (_a = reactionsByMessageId[message.id]) === null || _a === void 0
                ? void 0
        ...
        edited: mergedReplies.filter(function (message) {
          return !!message.isEdited;
        }).length,
        images: mergedReplies.filter(function (message) {
          var _a;
          return (_a = message.attachments) === null || _a === void 0
            ? void 0
            : _a.some(function (attachment) {
                return (0, shared_1.isImageAttachmentMimeType)(
                  attachment.mimeType,
                  attachment.fileName,
                );
              });
        ...
        attachments: mergedReplies.filter(function (message) {
          var _a, _b;
          return (
            ((_b = (_a = message.attachments) === null || _a === void 0 ? void 0 : _a.length) !==
              null && _b !== void 0
              ? _b
              : 0) > 0
          );
  ...
  var participantBaseReplies = (0, react_1.useMemo)(
    function () {
      var _a, _b;
      var lastReadMessageId =
        (_b = (_a = threadQuery.data) === null || _a === void 0 ? void 0 : _a.lastReadMessageId) !==
      ...
      return !deferredSearchQuery
        ...
        : baseByMode.filter(function (message) {
            ...
            var haystack = [
              ...
              (_c = (_b = message.author) === null || _b === void 0 ? void 0 : _b.displayName) !==
                null && _c !== void 0
                ? _c
                : '',
              (_e = (_d = message.author) === null || _d === void 0 ? void 0 : _d.username) !==
                null && _e !== void 0
                ? _e
                : '',
            ]
  ...
  var participantOptions = (0, react_1.useMemo)(
    function () {
      var _a, _b;
      var counts = new Map();
      for (
        var _i = 0, participantBaseReplies_1 = participantBaseReplies;
        _i < participantBaseReplies_1.length;
        _i++
      ) {
        var message = participantBaseReplies_1[_i];
        var userId = message.authorUserId;
        var label =
          ((_a = message.author) === null || _a === void 0 ? void 0 : _a.displayName) ||
      ...
      var allOptions = Array.from(counts.values())
        ...
        .map(function (option) {
          ...
          return __assign(__assign({}, option), {
            displayLabel:
              badges.length > 0
                ? ''.concat(option.label, ' \u00B7 ').concat(badges.join(' · '))
                : option.label,
          });
        });
      ...
      var selected = allOptions.find(function (option) {
        return option.userId === participantFilterUserId;
      });
      var topOptions = allOptions
    ...
    [
      currentUser === null || currentUser === void 0 ? void 0 : currentUser.id,
      participantBaseReplies,
      participantFilterUserId,
      starterUserId,
      t,
    ],
  );
  var activeParticipantOption = participantOptions.find(function (option) {
    return option.userId === participantFilterUserId;
  });
  var visibleReplies = (0, react_1.useMemo)(
    function () {
      var _a, _b;
      var lastReadMessageId =
        (_b = (_a = threadQuery.data) === null || _a === void 0 ? void 0 : _a.lastReadMessageId) !==
      ...
      var base = participantFilterUserId
        ? baseByMode.filter(function (message) {
            return message.authorUserId === participantFilterUserId;
          })
        : baseByMode;
      ...
      return __spreadArray([], filtered, true).sort(function (left, right) {
        ...
        if (sortField === 'author') {
          var leftAuthor = (
            ((_a = left.author) === null || _a === void 0 ? void 0 : _a.displayName) ||
            ((_b = left.author) === null || _b === void 0 ? void 0 : _b.username) ||
            ''
          ).toLocaleLowerCase();
          var rightAuthor = (
            ((_c = right.author) === null || _c === void 0 ? void 0 : _c.displayName) ||
            ((_d = right.author) === null || _d === void 0 ? void 0 : _d.username) ||
            ''
          ).toLocaleLowerCase();
        ...
        if (sortField === 'reactions') {
          var leftReactions =
            (_f =
              (_e = reactionsByMessageId[left.id]) === null || _e === void 0
                ? void 0
                : _e.reduce(function (sum, reaction) {
          ...
          var rightReactions =
            (_h =
              (_g = reactionsByMessageId[right.id]) === null || _g === void 0
                ? void 0
                : _g.reduce(function (sum, reaction) {
                    return sum + reaction.count;
                  }, 0)) !== null && _h !== void 0
              ? _h
              : 0;
  ...
  var firstUnreadVisibleReplyId = (0, react_1.useMemo)(
    function () {
      ...
      if (!lastReadMessageId) {
        return (_d = (_c = visibleReplies[0]) === null || _c === void 0 ? void 0 : _c.id) !==
          null && _d !== void 0
          ? _d
          : null;
      }
      return (_f =
        (_e = visibleReplies.find(function (message) {
  ...
  var unreadVisibleReplyCount = (0, react_1.useMemo)(
    function () {
      var _a, _b;
      if (
        filterMode !== 'all' ||
      ...
      return visibleReplies.filter(function (message) {
        return message.id > lastReadMessageId;
      }).length;
    },
    [
  ...
  var handleJumpToFirstUnread = (0, react_1.useCallback)(
    function () {
      var _a;
      if (!firstUnreadVisibleReplyId) {
        return;
      }
      var focusIndex = visibleReplies.findIndex(function (message) {
        return message.id === firstUnreadVisibleReplyId;
      });
      if (focusIndex === -1) {
        return;
      }
  ...
  var handleJumpToLatestReply = (0, react_1.useCallback)(
    function () {
      var _a, _b;
  ...
  var handleJumpToRoot = (0, react_1.useCallback)(
    function () {
      var _a;
  ...
  var activeFilters = (0, react_1.useMemo)(
    function () {
      var filters = [];
      if (searchQuery.trim()) {
        filters.push({
  ...
  var sendMutation = (0, react_query_1.useMutation)({
    mutationFn: function (bodyMarkdown) {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 2:
              return [
                4 /*yield*/,
                (0, api_1.api)('/api/threads/'.concat(threadId, '/messages'), {
                  method: 'POST',
                  body: { bodyMarkdown: bodyMarkdown },
                  headers: {
            ...
            case 3:
              ...
              if (
                !(
                  attachmentData &&
                  ((_a = result.message) === null || _a === void 0 ? void 0 : _a.id)
                )
              )
                return [3 /*break*/, 5];
              return [
              ...
              return [
                ...
                Promise.all([
                  ...
                  queryClient.invalidateQueries({
                    queryKey: ['message-reactions', 'thread', threadId],
                  }),
  ...
  var lockMutation = (0, react_query_1.useMutation)({
    mutationFn: function () {
      return (0, api_1.api)('/api/threads/'.concat(threadId, '/lock'), { method: 'POST' });
    },
    onSuccess: function () {
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              _a.trys.push([1, 3, , 4]);
              fallbackBody = trimmed || (pendingAttachment ? pendingAttachment.name || ' ' : ' ');
            ...
            case 3:
              error_1 = _a.sent();
              message =
                pendingAttachment && error_1 instanceof api_1.ApiError && error_1.status === 0
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              case 0:
                return [
                  4 /*yield*/,
                  (0, simulator_harness_1.readSimulatorHarnessJson)('dev-thread-reply.json'),
                ];
              case 1:
                parsed = _b.sent();
                if (!parsed) {
                ...
                return [
                  4 /*yield*/,
                  (0, simulator_harness_1.deleteSimulatorHarnessFile)('dev-thread-reply.json'),
                ];
              case 2:
                _b.sent();
                return [
                  4 /*yield*/,
                  handleSend(
                    ((_a = parsed === null || parsed === void 0 ? void 0 : parsed.body) === null ||
                    _a === void 0
                      ? void 0
                      : _a.trim()) || 'Simulator thread reply test',
                  ),
                ];
              case 3:
                _b.sent();
      ...
      for (var _i = 0, newEvents_1 = newEvents; _i < newEvents_1.length; _i++) {
        ...
        var eventThreadId =
          (_c =
            (_b =
              (_a =
                payloadThread === null || payloadThread === void 0 ? void 0 : payloadThread.id) !==
                null && _a !== void 0
                ? _a
                : payloadThread === null || payloadThread === void 0
                  ? void 0
                  : payloadThread.threadId) !== null && _b !== void 0
              ? _b
              : payloadMessage === null || payloadMessage === void 0
                ? void 0
                : payloadMessage.threadId) !== null && _c !== void 0
            ? _c
            : payload.threadId;
  ...
  var handleToggleFollow = (0, react_1.useCallback)(
    function () {
      var _a, _b;
      var isFollowing =
        (_b = (_a = threadQuery.data) === null || _a === void 0 ? void 0 : _a.isFollowing) !==
          null && _b !== void 0
          ? _b
          : false;
  ...
  var handleLock = (0, react_1.useCallback)(
    function () {
  ...
  var handleOpenContext = (0, react_1.useCallback)(
    function () {
      ...
      var channelType =
        (_a = channelQuery.data) === null || _a === void 0 ? void 0 : _a.channel.type;
      if (channelType === 'forum') {
        navigation.navigate('ForumChannelScreen', {
          channelId: channelId,
          communityId: route.params.communityId,
          channelName:
            (_c = (_b = channelQuery.data) === null || _b === void 0 ? void 0 : _b.channel.name) !==
              null && _c !== void 0
              ? _c
      ...
      navigation.navigate('ChannelScreen', {
        ...
        communityId: route.params.communityId,
        channelName:
          (_e = (_d = channelQuery.data) === null || _d === void 0 ? void 0 : _d.channel.name) !==
            null && _e !== void 0
            ? _e
            : route.params.channelName,
        focusMessageId:
          (_g =
            (_f = threadQuery.data) === null || _f === void 0
              ? void 0
              : _f.thread.rootMessageId) !== null && _g !== void 0
            ? _g
            : rootMessageId,
      });
    },
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 7:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                error_2 instanceof Error ? error_2.message : t('message.reactionFailed'),
              );
              return [3 /*break*/, 8];
            case 8:
              return [2 /*return*/];
    ...
    function () {
      ...
      return (0, api_1.api)('/api/translate', {
        ...
        .catch(function (error_3) {
          react_native_1.Alert.alert(
            t('common.error'),
            error_3 instanceof Error ? error_3.message : t('message.translateFailed'),
          );
        });
    },
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                (0, error_message_1.getUserFacingErrorMessage)(error_4, t),
              );
              return [3 /*break*/, 4];
            case 4:
              return [2 /*return*/];
  ...
  var handleAiRewriteDraft = (0, react_1.useCallback)(
    function () {
      return __awaiter(_this, void 0, void 0, function () {
        var contract, rewrittenDraft, error_5;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (!actionMessage) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                error_4 instanceof Error ? error_4.message : t('common.errorOccurred'),
              );
              return [3 /*break*/, 4];
            case 4:
              return [2 /*return*/];
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 7:
              ...
              react_native_1.Alert.alert(
                t('common.error'),
                error_7 instanceof Error ? error_7.message : t('channel.openAttachmentFailed'),
              );
              return [3 /*break*/, 9];
            case 8:
    ...
    function () {
      ...
      var isFollowing =
        (_b = (_a = threadQuery.data) === null || _a === void 0 ? void 0 : _a.isFollowing) !==
          ...
          ? _b
          : false;
      var canModerateThread =
        (_d =
          (_c = threadQuery.data) === null || _c === void 0
            ? void 0
            : _c.permissions.canModerateThread) !== null && _d !== void 0
          ? _d
          : false;
      var isLocked =
        (_f = (_e = threadQuery.data) === null || _e === void 0 ? void 0 : _e.thread.isLocked) !==
          null && _f !== void 0
          ? _f
          : false;
      navigation.setOptions({
        title:
          ((_g = threadQuery.data) === null || _g === void 0 ? void 0 : _g.thread.title) ||
          t('message.thread'),
  ...
  var canPostReply =
    (_v =
      (_u = threadQuery.data) === null || _u === void 0 ? void 0 : _u.permissions.canPostReply) !==
      null && _v !== void 0
      ? _v
      : false;
  var canUploadAttachment =
    (_x =
      (_w = channelPermissionsQuery.data) === null || _w === void 0
        ? void 0
        : _w.permissions.canUploadAttachment) !== null && _x !== void 0
      ? _x
      : true;
  var latestVisibleMessageId =
    mergedReplies.length > 0
      ? (_y = mergedReplies[mergedReplies.length - 1]) === null || _y === void 0
        ? void 0
        : _y.id
      : rootMessage === null || rootMessage === void 0
        ? void 0
        : rootMessage.id;
  (0, react_1.useEffect)(
    function () {
    ...
    >
      ...
      >
        <react_native_1.FlatList
          ...
          onScrollToIndexFailed={function (_a) {
            var _b, _c;
            var index = _a.index,
              averageItemLength = _a.averageItemLength;
            var target =
              (_b = pendingScrollTargetRef.current) !== null && _b !== void 0
                ? _b
                : { index: index, viewPosition: 0.5 };
            (_c = listRef.current) === null || _c === void 0
              ? void 0
              : _c.scrollToOffset({
          ...
          ListHeaderComponent={
            <react_native_1.View style={styles.header}>
              <react_native_1.Text style={styles.headerTitle}>
                {((_z = threadQuery.data) === null || _z === void 0 ? void 0 : _z.thread.title) ||
                  t('message.thread')}
              </react_native_1.Text>
              {rootMessage ? (
                <react_native_1.View
                ...
                >
                  <react_native_1.Text style={styles.rootLabel}>
                    {t('thread.rootMessage')}
                  </react_native_1.Text>
                  <react_native_1.TouchableOpacity
                    activeOpacity={0.75}
                    onLongPress={function () {
                      return setActionMessage(rootMessage);
                    }}
                    delayLongPress={400}
                  >
                    <MessageBubble_1.default
                      authorName={
                        (_1 =
                          (_0 = rootMessage.author) === null || _0 === void 0
                            ? void 0
                            : _0.displayName) !== null && _1 !== void 0
                          ? _1
                          : t('common.unknown')
                      }
                      body={
                        (0, shared_1.shouldHideAttachmentBody)(
                          rootMessage.bodyPlaintext || rootMessage.bodyMarkdown,
                          (_2 = rootMessage.attachments) !== null && _2 !== void 0 ? _2 : [],
                        )
                          ? ''
                          : rootMessage.bodyPlaintext
                      }
                      translatedBody={translatedBodies[rootMessage.id]?.entry?.translatedText}
                      translatedLabel={
                        translatedBodies[rootMessage.id]
                          ? translatedBodies[rootMessage.id].runtimeStatus === 'mock'
                            ? t('message.translatedMock')
                            : t('message.translated')
                          : undefined
                      }
                      time={new Date(rootMessage.createdAt).toLocaleTimeString('ko-KR', {
                        hour: 'numeric',
                        minute: '2-digit',
                        hour12: true,
                      })}
                      isOwn={
                        rootMessage.authorUserId ===
                        (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id)
                      }
                      isEdited={rootMessage.isEdited}
                      editedLabel={t('message.edited')}
                      reactions={((_3 = reactionsByMessageId[rootMessage.id]) !== null &&
                      _3 !== void 0
                        ? _3
                        : []
                  ...
                  {route.params.communityId ? (
                    ...
                    >
                      <react_native_1.Text style={styles.contextButtonText}>
                        {((_4 = channelQuery.data) === null || _4 === void 0
                          ? void 0
                          : _4.channel.type) === 'forum'
                ...
                <react_native_1.View style={styles.missingRoot}>
                  <react_native_1.Text style={styles.missingRootText}>
              ...
              {repliesQuery.hasNextPage ? (
                <react_native_1.TouchableOpacity
                  ...
                  activeOpacity={0.8}
                  onPress={function () {
                    return void repliesQuery.fetchNextPage();
                  }}
                ...
                >
                  {repliesQuery.isFetchingNextPage ? (
                    ...
                    <react_native_1.Text style={styles.loadOlderButtonText}>
                      {t('thread.loadOlder')}
                    </react_native_1.Text>
                  )}
                </react_native_1.TouchableOpacity>
                ...
                {[
                  ...
                  return (
                    <react_native_1.TouchableOpacity
                      ...
                      onPress={function () {
                        return setFilterMode(option.key);
                      }}
                    >
                      <react_native_1.Text
                        style={[
                          styles.sortChipText,
                          filterMode === option.key && styles.sortChipTextActive,
                        ]}
                      >
              ...
              {participantOptions.length > 0 ? (
                <react_native_1.View style={styles.sortRow}>
                  <react_native_1.TouchableOpacity
                    ...
                    onPress={function () {
                      return setParticipantFilterUserId(null);
                    }}
                  >
                    <react_native_1.Text
                      style={[
                  ...
                  {participantOptions.map(function (option) {
                    return (
                      <react_native_1.TouchableOpacity
                        key={option.userId}
                        style={[
                        ...
                        onPress={function () {
                          return setParticipantFilterUserId(option.userId);
                        }}
                      >
                        <react_native_1.Text
                          style={[
                ...
                {[
                  ...
                  return (
                    <react_native_1.TouchableOpacity
                      ...
                      onPress={function () {
                        return setSortField(option.key);
                      }}
                    >
                      <react_native_1.Text
                        style={[
                          styles.sortChipText,
                          sortField === option.key && styles.sortChipTextActive,
                        ]}
                      >
                        {option.label}
                      </react_native_1.Text>
                ...
                {[
                  ...
                  return (
                    <react_native_1.TouchableOpacity
                      ...
                      onPress={function () {
                        return setSortOrder(option.key);
                      }}
                    >
                      <react_native_1.Text
                        style={[
                          styles.sortChipText,
                          sortOrder === option.key && styles.sortChipTextActive,
                        ]}
                      >
                        {option.label}
                      </react_native_1.Text>
              ...
              {activeFilters.length > 0 ? (
                <react_native_1.View style={styles.activeFiltersRow}>
                  ...
                  >
                    <react_native_1.Text style={styles.clearFiltersChipText}>
                      {t('thread.clearFilters')}
                    </react_native_1.Text>
                  </react_native_1.TouchableOpacity>
                </react_native_1.View>
              ) : null}
          ...
          ListEmptyComponent={
            <react_native_1.View style={styles.emptyWrap}>
            ...
            return (
              <react_native_1.View>
                ...
                {item.id === firstUnreadVisibleReplyId ? (
                  <react_native_1.View style={styles.unreadDividerRow}>
                    <react_native_1.View style={styles.unreadDividerLine} />
                    <react_native_1.Text style={styles.unreadDividerText}>
              ...
              <react_native_1.TouchableOpacity
                ...
                activeOpacity={0.9}
                onPress={function () {
                  return setSelectedMessageId(function (current) {
                        ...
                        style={[
                          ...
                          isOwnMessage(
                            ...
                            currentUser === null || currentUser === void 0
                              ? void 0
                              : currentUser.id,
                          ) && styles.replyBadgeRowOwn,
                        ]}
                      >
                        <react_native_1.Text style={styles.replyBadgeText}>
                          {t('thread.starterBadge')}
                        </react_native_1.Text>
                      </react_native_1.View>
                    ) : null}
                    <MessageBubble_1.default
                      authorName={
                        (_c =
                          (_b = item.author) === null || _b === void 0
                            ? void 0
                            : _b.displayName) !== null && _c !== void 0
                          ? _c
                          : t('common.unknown')
                      }
                      authorAvatarUrl={
                        (_e =
                          (_d = item.author) === null || _d === void 0 ? void 0 : _d.avatarUrl) !==
                          null && _e !== void 0
                          ? _e
                          : null
                      }
                      body={
                        (0, shared_1.shouldHideAttachmentBody)(
                          ...
                          (_f = item.attachments) !== null && _f !== void 0 ? _f : [],
                        )
                          ? ''
                          : item.bodyPlaintext
                      }
                      ...
                      editedLabel={t('message.edited')}
                      reactions={((_g = reactionsByMessageId[item.id]) !== null && _g !== void 0
                        ? _g
                        : []
                      ).map(function (reaction) {
                        return {
                      ...
                      showAvatar={
                        index === 0 || visibleReplies[index - 1].authorUserId !== item.authorUserId
                      }
                      showAuthorName={
                        index === 0 || visibleReplies[index - 1].authorUserId !== item.authorUserId
                      }
        ...
        {pendingAttachment && (
          <react_native_1.View style={styles.attachmentPreview}>
        ...
        {showAttachMenu && (
          <react_native_1.View style={styles.attachMenu}>
            <react_native_1.TouchableOpacity
        ...
        {((_5 = threadQuery.data) === null || _5 === void 0 ? void 0 : _5.thread.isLocked) ? (
          <react_native_1.View style={styles.lockedBanner}>
            <react_native_1.Text style={styles.lockedText}>
              {t('thread.locked')}
            </react_native_1.Text>
          </react_native_1.View>
        ) : !canPostReply ? (
          ...
          <MessageComposer_1.default
            placeholder={
              editingMessage ? t('message.editPlaceholder') : t('thread.replyPlaceholder')
            }
              ...
              (_7 =
                (_6 =
                  editingMessage === null || editingMessage === void 0
                    ? void 0
                    : editingMessage.bodyMarkdown) !== null && _6 !== void 0
                  ? _6
                  : editingMessage === null || editingMessage === void 0
                    ? void 0
                    : editingMessage.bodyPlaintext) !== null && _7 !== void 0
                ? _7
                : composerDraftSeed
            }
            draftKey={
              (_8 =
                editingMessage === null || editingMessage === void 0
                  ? void 0
                  : editingMessage.id) !== null && _8 !== void 0
                ? _8
                : composerDraftKey
            }
          />
        ...
        <AttachmentLightbox_1.default
          attachments={
            (_9 =
              previewGallery === null || previewGallery === void 0
                ? void 0
                : previewGallery.attachments) !== null && _9 !== void 0
              ? _9
              : []
          }
          currentIndex={
            (_10 =
              previewGallery === null || previewGallery === void 0
                ? void 0
                : previewGallery.index) !== null && _10 !== void 0
              ? _10
              : 0
          }
          authToken={authToken}
          isSharing={
            ...
            ((_11 =
              previewGallery === null || previewGallery === void 0
                ? void 0
                : previewGallery.attachments[previewGallery.index]) === null || _11 === void 0
              ? void 0
              : _11.id)
          }
