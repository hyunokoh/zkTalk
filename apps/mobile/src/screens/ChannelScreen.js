...
function flattenMessage(item) {
    var _a, _b;
    if ('message' in item) {
        return __assign(__assign({}, item.message), { author: item.author, attachments: (_b = (_a = item.attachments) !== null && _a !== void 0 ? _a : item.message.attachments) !== null && _b !== void 0 ? _b : [] });
    }
    return item;
}
function ChannelScreen(_a) {
    ...
    var _0 = route.params, channelId = _0.channelId, focusMessageId = _0.focusMessageId;
    var _1 = (0, i18n_1.useTranslation)(), t = _1.t, locale = _1.locale;
    var rootNavigation = (0, native_1.useNavigation)();
    var listRef = (0, react_1.useRef)(null);
    var _2 = (0, react_1.useState)([]), pendingMessages = _2[0], setPendingMessages = _2[1];
    var _3 = (0, react_1.useState)(null), pendingAttachment = _3[0], setPendingAttachment = _3[1];
    var _4 = (0, react_1.useState)(null), uploadProgress = _4[0], setUploadProgress = _4[1];
    var _5 = (0, react_1.useState)(false), showAttachMenu = _5[0], setShowAttachMenu = _5[1];
    var _6 = (0, react_1.useState)(null), replyTo = _6[0], setReplyTo = _6[1];
    var _7 = (0, react_1.useState)(null), editingMessage = _7[0], setEditingMessage = _7[1];
    var _8 = (0, react_1.useState)(null), actionMessage = _8[0], setActionMessage = _8[1];
    var _9 = (0, react_1.useState)({}), translatedBodies = _9[0], setTranslatedBodies = _9[1];
    var _10 = (0, react_1.useState)(null), authToken = _10[0], setAuthToken = _10[1];
    var _11 = (0, react_1.useState)(null), openingAttachmentId = _11[0], setOpeningAttachmentId = _11[1];
    var _12 = (0, react_1.useState)(null), previewGallery = _12[0], setPreviewGallery = _12[1];
    var _13 = (0, react_1.useState)(null), selectedMessageId = _13[0], setSelectedMessageId = _13[1];
    var _14 = (0, react_1.useState)(''), topic = _14[0], setTopic = _14[1];
    ...
    var canManageChannel = (_b = permissionsData === null || permissionsData === void 0 ? void 0 : permissionsData.permissions.canManageChannel) !== null && _b !== void 0 ? _b : false;
    var canPostChannel = (_c = permissionsData === null || permissionsData === void 0 ? void 0 : permissionsData.permissions.canPostMessage) !== null && _c !== void 0 ? _c : true;
    var canReactToMessages = (_d = permissionsData === null || permissionsData === void 0 ? void 0 : permissionsData.permissions.canReact) !== null && _d !== void 0 ? _d : true;
    var canUploadAttachment = (_e = permissionsData === null || permissionsData === void 0 ? void 0 : permissionsData.permissions.canUploadAttachment) !== null && _e !== void 0 ? _e : true;
    var isArchived = (_f = channelDetailData === null || channelDetailData === void 0 ? void 0 : channelDetailData.channel.isArchived) !== null && _f !== void 0 ? _f : false;
    var requiresTopic = (_g = channelDetailData === null || channelDetailData === void 0 ? void 0 : channelDetailData.channel.requireTopic) !== null && _g !== void 0 ? _g : false;
    var sourceDmConversation = (_h = channelDetailData === null || channelDetailData === void 0 ? void 0 : channelDetailData.channel.sourceDmConversation) !== null && _h !== void 0 ? _h : null;
    var sourceDmName = ((_j = sourceDmConversation === null || sourceDmConversation === void 0 ? void 0 : sourceDmConversation.name) === null || _j === void 0 ? void 0 : _j.trim()) || null;
    ...
    var channelName = (_l = (_k = channelDetailData === null || channelDetailData === void 0 ? void 0 : channelDetailData.channel.name) !== null && _k !== void 0 ? _k : route.params.channelName) !== null && _l !== void 0 ? _l : t('nav.channel');
    var channelDescription = ((_m = channelDetailData === null || channelDetailData === void 0 ? void 0 : channelDetailData.channel.description) === null || _m === void 0 ? void 0 : _m.trim()) || t('channel.headerSubtitle');
    var openSourceDmHistory = (0, react_1.useCallback)(function () {
        var _a;
        ...
        rootNavigation.navigate('Main', {
            ...
            params: {
                ...
                params: {
                    ...
                    displayName: (_a = sourceDmConversation.name) !== null && _a !== void 0 ? _a : t('dm.message'),
                },
            },
        });
    }, [rootNavigation, sourceDmConversation, t]);
    var openChannelSearch = (0, react_1.useCallback)(function () {
    ...
    var openChannelPolls = (0, react_1.useCallback)(function () {
    ...
    var openChannelPins = (0, react_1.useCallback)(function () {
    ...
    var openEditChannel = (0, react_1.useCallback)(function () {
        if (!route.params.communityId) {
            return;
        }
    ...
    (0, react_1.useLayoutEffect)(function () {
        navigation.setOptions({
          ...
          {sourceDmConversation ? (<react_native_1.TouchableOpacity onPress={openSourceDmHistory} hitSlop={8} style={styles.headerHistoryAction} accessibilityRole="button" accessibilityLabel={sourceDmFullLabel}>
              <react_native_1.Text numberOfLines={1} ellipsizeMode="tail" style={styles.headerHistoryActionText}>
                {sourceDmHeaderLabel}
              </react_native_1.Text>
            </react_native_1.TouchableOpacity>) : null}
          {route.params.communityId ? (<react_native_1.TouchableOpacity onPress={openChannelSearch} hitSlop={8} style={styles.headerSearchAction} accessibilityRole="button" accessibilityLabel={t('channel.searchHintTitle')}>
              <react_native_1.Text style={styles.headerSearchActionText}>{t('channel.searchHintTitle')}</react_native_1.Text>
            </react_native_1.TouchableOpacity>) : null}
        </react_native_1.View>); },
        });
    }, [
    ...
    var _15 = (0, useWebSocket_1.useChannelSubscription)(channelId), queuedEventCount = _15.queuedEventCount, consumeEvents = _15.consumeEvents, typingUserIds = _15.typingUserIds;
    var _16 = (0, useWebSocket_1.useTypingIndicator)(channelId), startTyping = _16.startTyping, stopTyping = _16.stopTyping;
    var scheduleMessageRefresh = (0, react_1.useCallback)(function (delayMs) {
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        res = _c.sent();
                        messages = ((_a = res.messages) !== null && _a !== void 0 ? _a : []).map(flattenMessage);
                        return [2 /*return*/, {
                                messages: messages,
    ...
    }), data = _17.data, isLoading = _17.isLoading, refetch = _17.refetch, isRefetching = _17.isRefetching;
    var messages = (_o = data === null || data === void 0 ? void 0 : data.messages) !== null && _o !== void 0 ? _o : [];
    var unreadCounts = (_p = data === null || data === void 0 ? void 0 : data.unreadCounts) !== null && _p !== void 0 ? _p : {};
    var rootMessageIds = messages
        .filter(function (message) { return !message.parentMessageId && !message.threadId; })
    ...
    var threadSummariesData = (0, react_query_1.useQuery)({
        ...
        queryFn: function () {
            return (0, api_1.api)("/api/threads?rootMessageIds=".concat(encodeURIComponent(rootMessageIds.join(','))));
        },
    }).data;
    var threadSummariesByRootId = new Map(((_q = threadSummariesData === null || threadSummariesData === void 0 ? void 0 : threadSummariesData.items) !== null && _q !== void 0 ? _q : []).map(function (item) { return [item.thread.rootMessageId, item.thread]; }));
    var hasFocusedMessage = focusMessageId
        ? messages.some(function (message) { return message.id === focusMessageId; })
        : true;
    ...
    var mergedMessages = react_1.default.useMemo(function () {
        var baseMessages = focusedMessageData && !messages.some(function (message) { return message.id === focusedMessageData.id; })
            ? __spreadArray(__spreadArray([], messages, true), [focusedMessageData], false) : messages;
        var seen = new Set();
    ...
    var latestVisibleMessageId = (_s = (_r = mergedMessages[0]) === null || _r === void 0 ? void 0 : _r.id) !== null && _s !== void 0 ? _s : null;
    var messageIds = mergedMessages.map(function (message) { return message.id; });
    ...
    var reactionsByMessageId = (_t = reactionsData === null || reactionsData === void 0 ? void 0 : reactionsData.reactionsByMessageId) !== null && _t !== void 0 ? _t : {};
    var pollsData = (0, react_query_1.useQuery)({
        queryKey: ['polls-by-message', channelId, messageIds],
        enabled: messageIds.length > 0,
        queryFn: function () {
            return (0, api_1.api)("/api/polls?messageIds=".concat(messageIds.map(encodeURIComponent).join(',')));
        },
    }).data;
    var pollsByMessageId = (_u = pollsData === null || pollsData === void 0 ? void 0 : pollsData.pollsByMessageId) !== null && _u !== void 0 ? _u : {};
            ...
            switch (event_1.type) {
                case 'message.created': {
                    queryClient.setQueryData(['messages', channelId], function (old) {
                        ...
                        // Avoid duplicates
                        if (old.messages.some(function (m) { return m.id === newMsg.id; }))
                            return old;
                        return {
                ...
                case 'message.deleted': {
                    ...
                    queryClient.setQueryData(['messages', channelId], function (old) {
                        ...
                        if (!old)
                            return old;
                        return {
                            messages: old.messages.filter(function (m) { return m.id !== deletedId_1; }),
                            unreadCounts: (_a = old.unreadCounts) !== null && _a !== void 0 ? _a : {},
                        };
                    });
                    break;
        ...
        var checkPending = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        queued = _a.sent();
                        channelPending = queued.filter(function (m) { return m.endpoint === endpoint; });
                        setPendingMessages(channelPending.map(function (m) {
                            var _a;
                            return ({
                                id: m.id,
            ...
            void (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, (0, api_1.api)("/api/channels/".concat(channelId, "/read"), {
                                    method: 'POST',
    ...
    var sendMutation = (0, react_query_1.useMutation)({
        mutationFn: function (body) { return __awaiter(_this, void 0, void 0, function () {
            var attachmentData, pendingAttachmentName, err_1, fallbackBody, messageBody, trimmedTopic, result, err_2, shouldQueue, fallbackBody, queuedBody, trimmedTopic, queued_1;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!editingMessage) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, api_1.api)("/api/messages/".concat(editingMessage.id), {
                                method: 'PATCH',
                    ...
                    case 2:
                        attachmentData = null;
                        pendingAttachmentName = (_a = pendingAttachment === null || pendingAttachment === void 0 ? void 0 : pendingAttachment.name) !== null && _a !== void 0 ? _a : null;
                    ...
                    case 7:
                        result = _c.sent();
                        if (!(attachmentData && ((_b = result.message) === null || _b === void 0 ? void 0 : _b.id))) return [3 /*break*/, 9];
                        return [4 /*yield*/, (0, file_picker_1.attachToMessage)(result.message.id, attachmentData)];
                    case 8:
                        _c.sent();
                        _c.label = 9;
                    case 9: return [2 /*return*/, { queued: false }];
                    case 10:
                        err_2 = _c.sent();
    ...
    var handleOpenThread = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, (0, api_1.api)("/api/messages/".concat(actionMessage.id, "/thread"), {
                        method: 'POST',
                    })];
                case 3:
                    _a = (_b.sent()).id;
                ...
                case 5:
                    error_1 = _b.sent();
                    react_native_1.Alert.alert(t('common.error'), error_1 instanceof Error ? error_1.message : t('thread.openFailed'));
                    return [3 /*break*/, 6];
                case 6: return [2 /*return*/];
            }
        });
    }); }, [actionMessage, channelId, navigation, route.params.channelName, route.params.communityId, t]);
    var openThreadForMessage = (0, react_1.useCallback)(function (message) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 6, , 7]);
                    existingThreadId = (_c = threadSummariesByRootId.get(message.id)) === null || _c === void 0 ? void 0 : _c.id;
                ...
                case 1:
                    ...
                    _b = message.threadId;
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, (0, api_1.api)("/api/messages/".concat(message.id, "/thread"), {
                        method: 'POST',
                    })];
                case 3:
                    _b = (_d.sent()).id;
                ...
                case 6:
                    error_2 = _d.sent();
                    react_native_1.Alert.alert(t('common.error'), error_2 instanceof Error ? error_2.message : t('thread.openFailed'));
                    return [3 /*break*/, 7];
    ...
    var handleBookmark = (0, react_1.useCallback)(function () {
        if (!actionMessage)
            return;
        (0, api_1.api)("/api/bookmarks/".concat(actionMessage.id), { method: 'POST' }).catch(function (error) {
            react_native_1.Alert.alert(t('common.error'), error instanceof Error ? error.message : t('settings.bookmarksSaveFailed'));
        });
    }, [actionMessage, t]);
    var handlePin = (0, react_1.useCallback)(function () {
        if (!actionMessage)
            return;
        (0, api_1.api)("/api/channels/".concat(channelId, "/pins/").concat(actionMessage.id), { method: 'POST' }).catch(function (error) {
            react_native_1.Alert.alert(t('common.error'), error instanceof Error ? error.message : t('channel.pinFailed'));
        });
    ...
    var toggleReaction = (0, react_1.useCallback)(function (messageId, emoji) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 6:
                    error_3 = _c.sent();
                    react_native_1.Alert.alert(t('common.error'), error_3 instanceof Error ? error_3.message : t('message.reactionFailed'));
                    return [3 /*break*/, 7];
                case 7: return [2 /*return*/];
            }
        });
    }); }, [channelId, currentUser === null || currentUser === void 0 ? void 0 : currentUser.id, queryClient, reactionsByMessageId, t]);
    ...
    var handleTranslate = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_4 = _a.sent();
                    react_native_1.Alert.alert(t('common.error'), error_4 instanceof Error ? error_4.message : t('message.translateFailed'));
                    return [3 /*break*/, 4];
    ...
    var handleReport = (0, react_1.useCallback)(function () {
        ...
        react_native_1.Alert.alert(t('message.reportTitle'), t('message.reportBody'), [
            { text: t('common.cancel'), style: 'cancel' },
            {
                ...
                onPress: function () { return submitReport('spam'); },
            },
            {
                text: t('message.reportHarassment'),
                onPress: function () { return submitReport('harassment'); },
            },
            {
                text: t('message.reportInappropriate'),
                onPress: function () { return submitReport('inappropriate'); },
            },
        ]);
    ...
    var handlePickDocument = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_7 = _a.sent();
                    react_native_1.Alert.alert(t('common.error'), error_7 instanceof Error ? error_7.message : t('common.errorOccurred'));
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    var handleShareAttachment = (0, react_1.useCallback)(function (attachment) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    error_8 = _b.sent();
                    react_native_1.Alert.alert(t('common.error'), error_8 instanceof Error ? error_8.message : t('channel.openAttachmentFailed'));
                    return [3 /*break*/, 9];
                case 8:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, , 8, 9]);
                            if ((payload === null || payload === void 0 ? void 0 : payload.channelId) !== channelId) {
                                return [2 /*return*/];
                            }
    ...
    (0, react_1.useEffect)(function () {
        if (!simulator_harness_1.isSimulatorHarnessEnabled || devAttachmentAttemptedRef.current || !simulator_harness_1.simulatorHarnessDirectory) {
            return;
        }
        var cancelled = false;
        ...
        function tryDevAttachment() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, (0, simulator_harness_1.readSimulatorHarnessJson)('dev-attachment.json')];
                        case 1:
                            payload = _d.sent();
                            if (!payload || cancelled) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, (0, simulator_harness_1.deleteSimulatorHarnessFile)('dev-attachment.json')];
                        case 3:
                            _d.sent();
                            if ((payload === null || payload === void 0 ? void 0 : payload.channelId) !== channelId ||
                            ...
                            tempUri = "".concat(simulator_harness_1.simulatorHarnessDirectory).concat(tempFileName);
                            return [4 /*yield*/, LegacyFileSystem.writeAsStringAsync(tempUri, payload.contents)];
                        case 4:
                            _d.sent();
                            return [4 /*yield*/, (0, file_picker_1.uploadFile)({
                                    uri: tempUri,
                                    name: tempFileName,
                        ...
                        case 5:
                            ...
                            messageBody = {
                                bodyMarkdown: ((_a = payload.body) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = payload.fileName) === null || _b === void 0 ? void 0 : _b.trim()) || ' ',
                            };
                            trimmedTopic = topic.trim();
                            if (trimmedTopic) {
                                messageBody.topic = trimmedTopic;
                        ...
                        case 6:
                            result = _d.sent();
                            if (!((_c = result.message) === null || _c === void 0 ? void 0 : _c.id)) return [3 /*break*/, 9];
                            return [4 /*yield*/, (0, file_picker_1.attachToMessage)(result.message.id, attachmentData)];
                        case 7:
                            _d.sent();
                            return [4 /*yield*/, queryClient.invalidateQueries({ queryKey: ['messages', channelId] })];
                        case 8:
                            _d.sent();
                            _d.label = 9;
                        case 9: return [4 /*yield*/, (0, simulator_harness_1.deleteSimulatorHarnessPath)(tempUri)];
                        case 10:
                            _d.sent();
                            return [3 /*break*/, 12];
                        case 11:
    ...
    (0, react_1.useEffect)(function () {
        if (!focusMessageId || mergedMessages.length === 0)
            return;
        var focusIndex = mergedMessages.findIndex(function (message) { return message.id === focusMessageId; });
        if (focusIndex === -1)
            return;
    ...
    var messagesById = new Map(mergedMessages.map(function (message) { return [message.id, message]; }));
    var renderAttachments = function (attachments, isOwn) {
        ...
        {imageAttachments.length > 0 ? (<react_native_1.View style={[
            ...
            {visibleImageAttachments.map(function (attachment, index) {
                    ...
                    var extraCount = imageAttachments.length > 4 && index === 3
                        ...
                        : 0;
                    return (<react_native_1.TouchableOpacity key={attachment.id} testID={"channel-attachment-image-".concat(attachment.id)} style={[
        ...
        {fileAttachments.map(function (attachment) { return (<react_native_1.View key={attachment.id} style={styles.attachmentItem}>
            <react_native_1.TouchableOpacity testID={"channel-attachment-file-".concat(attachment.id)} style={styles.attachmentFile} activeOpacity={0.8} onPress={function () { return void handleOpenAttachment(attachment, attachments); }} disabled={openingAttachmentId === attachment.id}>
    ...
    return (<react_native_1.KeyboardAvoidingView testID="channel-screen" style={styles.container} behavior={react_native_1.Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={90}>
      <react_native_1.View style={styles.channelHeroWrap}>
        <react_native_1.View style={styles.channelHeroCard}>
          <react_native_1.Text style={styles.channelHeroEyebrow}>{t('nav.channel')}</react_native_1.Text>
          <react_native_1.Text testID="channel-screen-title" style={styles.channelHeroTitle}># {channelName}</react_native_1.Text>
          <react_native_1.Text style={styles.channelHeroBody}>{channelDescription}</react_native_1.Text>
          <react_native_1.View style={styles.channelHeroMetaRow}>
            {requiresTopic ? (<react_native_1.View style={styles.channelHeroMetaBadge}>
                <react_native_1.Text style={styles.channelHeroMetaBadgeText}>{t('channel.requireTopic')}</react_native_1.Text>
              </react_native_1.View>) : null}
            {isArchived ? (<react_native_1.View style={styles.channelHeroMetaBadge}>
                <react_native_1.Text style={styles.channelHeroMetaBadgeText}>{t('channel.archivedTitle')}</react_native_1.Text>
              </react_native_1.View>) : null}
          </react_native_1.View>
          <react_native_1.View style={styles.channelHeroActionRow}>
            {route.params.communityId ? (<react_native_1.TouchableOpacity onPress={openChannelSearch} activeOpacity={0.85} style={styles.channelHeroActionChip}>
                <react_native_1.Text style={styles.channelHeroActionChipText}>{t('channel.searchHintTitle')}</react_native_1.Text>
              </react_native_1.TouchableOpacity>) : null}
            <react_native_1.TouchableOpacity onPress={openChannelPolls} activeOpacity={0.85} style={styles.channelHeroActionChip}>
              <react_native_1.Text style={styles.channelHeroActionChipText}>{t('poll.title')}</react_native_1.Text>
            </react_native_1.TouchableOpacity>
            <react_native_1.TouchableOpacity onPress={openChannelPins} activeOpacity={0.85} style={styles.channelHeroActionChip}>
              <react_native_1.Text style={styles.channelHeroActionChipText}>{t('pin.pinned')}</react_native_1.Text>
            </react_native_1.TouchableOpacity>
            {canManageChannel && route.params.communityId ? (<react_native_1.TouchableOpacity onPress={openEditChannel} activeOpacity={0.85} style={[styles.channelHeroActionChip, styles.channelHeroActionChipPrimary]}>
      ...
      {sourceDmConversation && (<react_native_1.View style={styles.sourceHistoryBannerWrap}>
          <react_native_1.TouchableOpacity activeOpacity={0.85} onPress={openSourceDmHistory} style={styles.sourceHistoryBanner} accessibilityRole="button" accessibilityLabel={sourceDmFullLabel}>
            <react_native_1.View style={styles.sourceHistoryBadge}>
              <react_native_1.Text style={styles.sourceHistoryBadgeText}>{t('dm.historyBadge')}</react_native_1.Text>
            </react_native_1.View>
            {sourceDmTypeLabel ? (<react_native_1.View style={styles.sourceHistoryTypeBadge}>
                <react_native_1.Text style={styles.sourceHistoryTypeBadgeText}>{sourceDmTypeLabel}</react_native_1.Text>
              </react_native_1.View>) : null}
            <react_native_1.View style={styles.sourceHistoryContent}>
              <react_native_1.Text style={styles.sourceHistoryTitle}>{t('channel.sourceDmTitle')}</react_native_1.Text>
              {sourceDmName ? (<react_native_1.Text style={styles.sourceHistoryName}>
                  {t('channel.sourceDmNameLabelWithName', { name: sourceDmName })}
                </react_native_1.Text>) : null}
              <react_native_1.Text style={styles.sourceHistoryBody}>{sourceDmBody}</react_native_1.Text>
            </react_native_1.View>
            <react_native_1.View style={styles.sourceHistoryButton}>
              <react_native_1.Text style={styles.sourceHistoryButtonText}>{t('dm.viewHistoryShort')}</react_native_1.Text>
            </react_native_1.View>
          </react_native_1.TouchableOpacity>
        </react_native_1.View>)}

      <react_native_1.FlatList testID="channel-message-list" ref={listRef} data={mergedMessages} keyExtractor={function (item) { return item.id; }} inverted showsVerticalScrollIndicator={false} onScrollToIndexFailed={function () { }} keyboardShouldPersistTaps="handled" keyboardDismissMode={react_native_1.Platform.OS === 'ios' ? 'interactive' : 'on-drag'} refreshControl={<react_native_1.RefreshControl refreshing={isFocused && isRefetching} onRefresh={refetch} tintColor={theme_1.colors.primary}/>} renderItem={function (_a) {
            ...
            var nextMessage = index < mergedMessages.length - 1 ? mergedMessages[index + 1] : undefined;
            ...
            return (<react_native_1.TouchableOpacity activeOpacity={0.9} onPress={function () {
              ...
              <react_native_1.View style={item.id === focusMessageId
                    ? styles.focusedMessageWrap
                    : undefined}>
              <MessageBubble_1.default authorName={(_d = (_c = item.author) === null || _c === void 0 ? void 0 : _c.displayName) !== null && _d !== void 0 ? _d : t('common.unknown')} authorAvatarUrl={(_f = (_e = item.author) === null || _e === void 0 ? void 0 : _e.avatarUrl) !== null && _f !== void 0 ? _f : null} body={displayBody} topic={item.topic} translatedBody={translatedBodies[item.id]} translatedLabel={translatedBodies[item.id] ? t('message.translated') : undefined} replyAuthorName={(_h = (_g = repliedMessage === null || repliedMessage === void 0 ? void 0 : repliedMessage.author) === null || _g === void 0 ? void 0 : _g.displayName) !== null && _h !== void 0 ? _h : t('message.reply')} replyBody={item.parentMessageId
                    ? (_j = repliedMessage === null || repliedMessage === void 0 ? void 0 : repliedMessage.bodyPlaintext) !== null && _j !== void 0 ? _j : t('message.replyUnavailable')
                    : undefined} time={new Date(item.createdAt).toLocaleTimeString([], {
                    hour: '2-digit',
                    minute: '2-digit',
                })} isOwn={isOwn} isEdited={item.isEdited} editedLabel={t('message.edited')} readCount={unreadCounts[item.id]} showAvatar={startsGroup} showAuthorName={startsGroup} startsGroup={startsGroup} endsGroup={endsGroup} showActionChips={selectedMessageId === item.id} reactions={((_k = reactionsByMessageId[item.id]) !== null && _k !== void 0 ? _k : []).map(function (reaction) { return ({
                    ...
                    ? __assign(__assign({}, messagePoll), { footerLabel: "".concat(t('poll.totalVotes', { count: messagePoll.totalVotes }), " \u2022 ").concat(messagePoll.closed ? t('poll.closed') : t('poll.open')) }) : undefined} onPressPollOption={messagePoll
                    ...
                    : undefined} onPressReaction={canReactToMessages
                    ? function (emoji) {
                        void toggleReaction(item.id, emoji);
                    }
                    : undefined} onPressAddReaction={canReactToMessages ? function () { return setActionMessage(item); } : undefined} onPressMore={function () { return setActionMessage(item); }} threadButtonLabel={threadSummary
                    ? t('thread.openThread', { count: threadSummary.replyCount })
                    : undefined} onPressThread={threadSummary
                    ? function () {
        ...
        }} ListHeaderComponent={pendingMessages.length > 0 ? (<react_native_1.View style={styles.pendingSection}>
            ...
            <EmptyState_1.default icon="message" title={t('channel.noMessages')} subtitle={t('channel.beFirst')}/>
      ...
      {/* Typing indicator */}
      {typingUserIds.length > 0 && (<react_native_1.View style={styles.typingBar}>
      ...
      {/* Reply indicator */}
      {replyTo && (<react_native_1.View style={styles.replyBar}>
          <react_native_1.View style={styles.replyContent}>
            <react_native_1.Text style={styles.replyLabel}>{t('message.reply')}</react_native_1.Text>
            <react_native_1.Text style={styles.replyText} numberOfLines={1}>
              {replyTo.bodyPlaintext}
            </react_native_1.Text>
          </react_native_1.View>
          <react_native_1.TouchableOpacity onPress={function () { return setReplyTo(null); }}>
            <react_native_1.Text style={styles.replyClose}>{"\u2715"}</react_native_1.Text>
          </react_native_1.TouchableOpacity>
        </react_native_1.View>)}

      {editingMessage && (<react_native_1.View style={styles.replyBar}>
          <react_native_1.View style={styles.replyContent}>
      ...
      {!isArchived && canPostChannel && requiresTopic && (<react_native_1.View style={styles.topicBar}>
          <react_native_1.Text style={styles.topicLabel}>{t('channel.topic')}</react_native_1.Text>
          <react_native_1.TextInput style={styles.topicInput} value={topic} onChangeText={setTopic} placeholder={t('channel.topicPlaceholder')} placeholderTextColor={theme_1.colors.textDim} maxLength={200}/>
        </react_native_1.View>)}

      {/* Pending attachment preview */}
      {pendingAttachment && (<react_native_1.View testID="channel-pending-attachment" style={styles.attachmentPreview}>
          {(0, shared_1.isImageAttachmentMimeType)(pendingAttachment.mimeType, pendingAttachment.name) ? (<>
              <react_native_1.Image testID="channel-pending-attachment-image" source={{ uri: pendingAttachment.uri }} style={styles.previewImage} resizeMode="cover"/>
              <react_native_1.View style={styles.previewMeta}>
                ...
                <react_native_1.Text testID="channel-pending-attachment-name" style={styles.previewFileName} numberOfLines={1}>
          ...
          <react_native_1.TouchableOpacity testID="channel-pending-attachment-remove" style={styles.removeAttachment} onPress={function () { return setPendingAttachment(null); }}>
      ...
      {/* Attachment menu */}
      {showAttachMenu && (<react_native_1.View testID="channel-attach-menu" style={styles.attachMenu}>
          <react_native_1.TouchableOpacity testID="channel-attach-menu-photo" style={styles.attachMenuItem} onPress={handlePickImage}>
            <react_native_1.Text style={styles.attachMenuText}>{t('channel.photoVideo')}</react_native_1.Text>
          </react_native_1.TouchableOpacity>
          <react_native_1.TouchableOpacity testID="channel-attach-menu-camera" style={styles.attachMenuItem} onPress={handleTakePhoto}>
            <react_native_1.Text style={styles.attachMenuText}>{t('channel.camera')}</react_native_1.Text>
          </react_native_1.TouchableOpacity>
          <react_native_1.TouchableOpacity testID="channel-attach-menu-document" style={styles.attachMenuItem} onPress={handlePickDocument}>
            <react_native_1.Text style={styles.attachMenuText}>{t('channel.document')}</react_native_1.Text>
          </react_native_1.TouchableOpacity>
        </react_native_1.View>)}

      {(isArchived || !canPostChannel) && (<react_native_1.View style={styles.archivedBanner}>
          <react_native_1.Text style={styles.archivedBannerTitle}>{t('channel.archivedTitle')}</react_native_1.Text>
      ...
      {/* Composer */}
      {!isArchived && canPostChannel && (<MessageComposer_1.default placeholder={editingMessage ? t('message.editPlaceholder') : t('channel.messageInput')} sendLabel={editingMessage ? t('common.save') : t('channel.send')} sendingLabel={t('channel.sending')} isSending={sendMutation.isPending} onSend={handleSend} onTypingStart={startTyping} onTypingStop={stopTyping} onPressAdd={editingMessage || !canUploadAttachment ? undefined : handleToggleAttachMenu} allowEmptySubmit={!!pendingAttachment} draftText={(_v = editingMessage === null || editingMessage === void 0 ? void 0 : editingMessage.bodyMarkdown) !== null && _v !== void 0 ? _v : ''} draftKey={(_w = editingMessage === null || editingMessage === void 0 ? void 0 : editingMessage.id) !== null && _w !== void 0 ? _w : null}/>)}

      <AttachmentLightbox_1.default attachments={(_x = previewGallery === null || previewGallery === void 0 ? void 0 : previewGallery.attachments) !== null && _x !== void 0 ? _x : []} currentIndex={(_y = previewGallery === null || previewGallery === void 0 ? void 0 : previewGallery.index) !== null && _y !== void 0 ? _y : 0} authToken={authToken} isSharing={openingAttachmentId === ((_z = previewGallery === null || previewGallery === void 0 ? void 0 : previewGallery.attachments[previewGallery.index]) === null || _z === void 0 ? void 0 : _z.id)} closeLabel={t('common.cancel')} shareLabel={t('channel.shareAttachment')} sharingLabel={t('channel.openingAttachment')} previousLabel={t('lightbox.previous')} nextLabel={t('lightbox.next')} onClose={function () { return setPreviewGallery(null); }} onNavigate={function (index) {
      ...
      {actionMessage && (<MessageActionSheet_1.default message={actionMessage} isOwn={actionMessage.authorUserId === (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id)} onReply={canPostChannel ? handleReply : undefined} onThread={handleOpenThread} onEdit={canPostChannel && actionMessage.authorUserId === (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id)
                ? handleEdit
                : undefined} onReport={actionMessage.authorUserId !== (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id) && route.params.communityId
                ? handleReport
                : undefined} onTranslate={handleTranslate} onReact={canReactToMessages ? handleReact : undefined} onPin={handlePin} onBookmark={handleBookmark} onClose={function () { return setActionMessage(null); }} onDelete={handleDelete}/>)}
...
var styles = react_native_1.StyleSheet.create({
    ...
    attachmentImageMoreOverlay: __assign(__assign({}, react_native_1.StyleSheet.absoluteFillObject), { alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(32, 48, 64, 0.42)' }),
