...
const APP_SHELL_WAIT_MS = 15_000;
...
async function waitForAuthenticatedShell(page: Page, url: string) {
...
async function waitForAuthenticatedRoute(page: Page, url: string) {
  let lastError: unknown;
